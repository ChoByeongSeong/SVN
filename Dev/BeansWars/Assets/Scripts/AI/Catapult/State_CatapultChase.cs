...
public class State_CatapultChase : State
{
    ...
    public State_CatapultChase(StateController controller) : base(controller)
    {
    ...
    IEnumerator FollowTarget()
    {
        ...
        while (true)
        {
            ...
            // 투석기만 좌우가 다르다.
            // 왼쪽이 1
            int dir = (targetPos.x - controller.Position.x < 0) ? 1 : 0;
            controller.modelTr.rotation = Quaternion.Euler(new Vector3(0, 180 * dir, 0));
    ...
    IEnumerator FollowPath()
    {
        ...
        while (followingPath)
        {
            ...
            if (followingPath)
            {
                ...
                // 투석기만 좌우가 다르다.
                // 왼쪽이 1
                int dir = (path.nextPoints[pathIndex].x - controller.Position.x < 0) ? 1 : 0;
                controller.modelTr.rotation = Quaternion.Euler(new Vector3(0, 180 * dir, 0));
            }
